class Game {
  ...
  start() {
    ...
    var obstacle1Positions = [
      ...
      { x: width / 2 + 350, y: height - 1800, image: obstacle1Image },
    ...
    var obstacle2Positions = [
      { x: width / 2 + 140, y: height + 1200, image: obstacle2Image },
      { x: width / 2 + 250, y: height - 1900, image: obstacle2Image },
      { x: width / 2 - 270, y: height - 2300, image: obstacle2Image },
